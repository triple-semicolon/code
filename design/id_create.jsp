...
<body class="backcolor">
    ...
    <div class="form">
        <form class="login-form" method="POST" enctype="multipart/form-data">
           ...
           <button type="button" onclick="alert('회원가입이 완료되었습니다'); location.href='login_css.jsp';">CREATE</button>
           <p class="message">Already registered? <a href="login_css.jsp">Sign In</a></p>
        </form>
    </div>
</body>
</html>
