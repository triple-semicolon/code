...
<body>
    ...
    <div>
        ...
        <div class="content">
            ...
            <div class="qna_list">
                <div class="list">
                    <a href="qna_things.jsp">질문 1</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 2</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 3</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 4</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 5</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 6</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 7</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 8</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 9</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 10</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 11</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 12</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 13</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 14</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
                <div class="list">
                    <a href="qna_things.jsp">질문 15</a>
                    <a style="float: right;" href="user1">유저네임</a>
                </div>
            </div>
        </div>
