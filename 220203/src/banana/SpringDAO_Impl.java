    ...
    public List<SpringVO> findAll() throws Exception {
        RowMapper<SpringVO> rowMapper = new RowMapper<SpringVO>() {
            ...
            public SpringVO mapRow(ResultSet rs, int idx) throws SQLException {
                ...
                vo.setUsername(Util.han(rs.getString("username")));
                vo.setTitle(Util.han(rs.getString("title")));
                vo.setContent(Util.han(rs.getString("content")));
                vo.setOfn(Util.han(rs.getString("ofn")));
                vo.setFsn(Util.han(rs.getString("fsn")));
                vo.setView(rs.getInt("view"));
                vo.setRecommend(rs.getInt("recommend"));
                vo.setTime(Util.han(rs.getString("time")));
                return vo;
            }
        };
    ...
    public int add(final SpringVO pvo) throws Exception {
        PreparedStatementSetter pss = new PreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement stmt) throws SQLException {
                stmt.setString( 1, pvo.getUsername() );
                stmt.setString( 2, pvo.getTitle() );
                stmt.setString( 3, pvo.getContent() );
